...
map \rq :call VimuxRunCommand("clear; rspec" . bufname("%"), 0)
map \rb :call VimuxRunCommand("clear; rspec" . bufname("%"))
...
set report=0
set ruler
set runtimepath=~/.vim,~/.vim/plugged/coc.nvim,~/.fzf,~/.vim/plugged/vim-devicons,~/.vim/plugged/nerdtree,~/.vim/plugged/ale,~/.vim/plugged/tagbar,~/.vim/plugged/nerdcommenter,~/.vim/plugged/vimux,~/.vim/plugged/vim-gutentags,~/.vim/plugged/vim-prettier,~/.vim/plugged/vim-fugitive,~/.vim/plugged/vim-gitbranch,~/.vim/plugged/nerd-fonts,~/.vim/plugged/devicons-shell,~/.vim/plugged/vim-airline,~/.vim/plugged/vim-airline-themes,~/.vim/plugged/vimfiler.vim,~/.vim/plugged/vim-startify,~/.vim/plugged/lightline.vim,/var/lib/vim/addons,/etc/vim,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,/etc/vim/after,/var/lib/vim/addons/after,~/.vim/after,~/.config/coc/extensions/node_modules/coc-explorer,~/.config/coc/extensions/node_modules/coc-snippets
set secure
set shiftwidth=2
...
set showmatch
set smartindent
set statusline=%t%m%r%y%=%c%V%P,%l:%L%F%h%w
...
silent! normal! zE
let s:l = 98 - ((33 * winheight(0) + 24) / 49)
